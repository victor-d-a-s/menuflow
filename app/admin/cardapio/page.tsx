  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      <div className="flex items-center gap-3 border-b pb-6">
        <div className="p-2 bg-orange-100 text-orange-700 rounded-lg"><UtensilsCrossed className="w-6 h-6" /></div>
        <div><h1 className="text-3xl font-bold tracking-tight">Cardápio</h1><p className="text-muted-foreground">Gerencie categorias e produtos.</p></div>
      </div>
      <CardapioManager categories={categories||[]} products={products||[]} />
    </div>
  )
}
