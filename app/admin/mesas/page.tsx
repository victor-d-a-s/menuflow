  ...
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-6">
      <div className="flex items-center gap-3 border-b pb-6">
        <div className="p-2 bg-purple-100 text-purple-700 rounded-lg"><Table2 className="w-6 h-6"/></div>
        <div><h1 className="text-3xl font-bold tracking-tight">Mesas & QR Code</h1><p className="text-muted-foreground">Crie mesas e gere QR codes.</p></div>
      </div>
      <MesasManager tables={tables||[]} restaurantId={profile.restaurant_id} slug={restaurant?.slug||''} />
    </div>
  )
}
